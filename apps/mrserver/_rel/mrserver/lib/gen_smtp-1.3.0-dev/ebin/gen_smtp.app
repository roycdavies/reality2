{application,gen_smtp,
             [{description,"The extensible Erlang SMTP client and server library."},
              ...
              {modules, ['binstr','gen_smtp_client','gen_smtp_server','gen_smtp_server_session','mimemail','smtp_rfc5322_parse','smtp_rfc5322_scan','smtp_rfc822_parse','smtp_server_example','smtp_socket','smtp_util']}]}.
